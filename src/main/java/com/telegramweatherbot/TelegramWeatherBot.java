...
public class TelegramWeatherBot {
            ...
            updates.forEach(update -> {
                ...
                switch (userMessage) {
                    ...
                    case "/forecasthere": {
                        ...
                        String contents = com.telegramweatherbot.HTTPRequest.getLocation(latitude, longitude);
                        Gson gson = new Gson();
                        com.telegramweatherbot.LocationByGeo location = gson.fromJson(contents, com.telegramweatherbot.LocationByGeo.class);
                    ...
                    default: {
                        ...
                        if (cityNameInputOn) {
                            ...
                            String contents = com.telegramweatherbot.HTTPRequest.getCities(cityName);
                            Gson gson = new Gson();
                            locations = gson.fromJson(contents, com.telegramweatherbot.LocationByCity[].class);
    ...
    private static String getForecastMessage(String code) {
        String contents = com.telegramweatherbot.HTTPRequest.get12HourForecast(code);
        Gson gson = new Gson();
        com.telegramweatherbot.HourForecast[] hourForecasts = gson.fromJson(contents, com.telegramweatherbot.HourForecast[].class);
        StringBuilder message = new StringBuilder("Прогноз на ближайшие 12 часов:\n");

        for (com.telegramweatherbot.HourForecast f : hourForecasts) {
